...
{
    float percent_marks_in_12th;
    String stream;

    Graduate_Student(String name, String program, int age, float percent_marks_in_12th, String stream) {
...
class Research_Student extends Student
{
    ...
    Research_Student(String name, String program, int age, String specialization, int years_of_experience) {
        super(name, program, age);
